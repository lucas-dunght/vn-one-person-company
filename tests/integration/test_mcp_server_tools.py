...
Verifies:
- module imports + 7 tools registered with FastMCP
...
def test_mcp_server_imports():
    """Server module imports + all 7 tool fns exposed."""
...
def test_mcp_server_has_7_tools():
    """FastMCP.list_tools() returns the 7 registered tools."""
